...
export interface ApiCapabilitiesSectionCapabilitiesSection
  extends Struct.SingleTypeSchema {
  collectionName: 'capabilities_sections';
  info: {
    description: 'Content for the capabilities hero section';
    displayName: 'Capabilities Section';
    pluralName: 'capabilities-sections';
    singularName: 'capabilities-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'We work across websites, e-commerce, mobile apps, CMS platforms, custom products, AI led experiences, and long term support teams. Each capability is shaped through the same connected process: strategy, design, build, and growth.'>;
    label: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Capabilities'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::capabilities-section.capabilities-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Digital Work, Built Across The Full Stack.'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Deep dive into a project using premium editorial template';
  ...
  attributes: {
    ...
    approachBrandText: Schema.Attribute.String;
    approachPrinciples: Schema.Attribute.Component<
      'elements.feature-item',
      true
    >;
    approachText: Schema.Attribute.Text;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'General page builder';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portfolio projects with full visual configuration';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    barBg: Schema.Attribute.String;
    barBorder: Schema.Attribute.String;
    bg: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#000000'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cursorColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#95E7D3'>;
    description: Schema.Attribute.Text;
    layout: Schema.Attribute.Enumeration<['mobile', 'desktop']> &
